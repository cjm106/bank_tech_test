...
describe Statement do
  ...
  it "is able return withdrawals in the format: 'date ||  || withdrawal || balance' "do
    subject = Statement.new([],[["20/01/2001","",1000, -1000]])
    expect{subject.ledger}.to output("20/01/2001 ||  || 1000 || -1000\n").to_stdout
  end

  it "is able return deposits and withdrawals in the expected format: 'date || deposit || withdrawal || balance' "do
